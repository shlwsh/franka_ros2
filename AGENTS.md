...
**新增规则**：所有输出的方案、文稿，及其**文件名称**，均应该明确标有版本号与时间戳信息。

## Paper I Cursor 技能（`.cursor/skills/`）
...
This project is indexed by GitNexus as **franka_ros2** (8466 symbols, 12917 relationships, 261 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
