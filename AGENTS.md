...
This project is indexed by GitNexus as **franka_ros2** (8271 symbols, 11625 relationships, 187 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
