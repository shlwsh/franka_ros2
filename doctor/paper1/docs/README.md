...
> **学习手册**（[`study/`](./study/README.md)）与本目录 L1 汇总同仓，**不另维护数字副本**；发现不一致时以 JSON/CSV 为准并运行汇总脚本刷新 Markdown。
...
| **L2 叙事解读** | [`study/`](./study/README.md) | 概念、答辩、架构；引用 L0/L1，不引用 `docs-zh/paper1/论文I_*` |
...
| [study/README.md](./study/README.md) | **学习手册入口**（8 章叙事 + 答辩） | Cursor `@paper1-study-handbook` |
...
概念与答辩：[study/README.md](./study/README.md)（读者入口）  
维护流程：`.cursor/skills/paper1-study-handbook/`（Agent 刷新 L2 手册）

旧路径 `docs-zh/paper1/study/` 已弃用，仅保留跳转 stub。
