...
> **代码与数字依据**：`doctor/paper1/sim/resample_physics.yaml`、`langgraph_router/`、`experiments/results/algo_quick_summary.json` · 汇总见 [`doctor/paper1/docs/`](../README.md)  
> **更新日期**：2026-06-04
...
1. ~~**网络扰动 sweep**~~：✅ quick 见 `doctor/paper1/experiments/results/network_sweep_quick.json` · [`验证结果_快速.md`](../验证结果_快速.md) §3  
...
6. ~~**全量 3 seeds**~~：✅ 见 [`验证结果_全量.md`](../验证结果_全量.md)  
7. ~~**多智能体审核 P0–P2**~~：✅ `doctor/paper1/reviews/20260603-213904/`

复现索引：[`doctor/paper1/REPRODUCE.md`](../../REPRODUCE.md)
...
- [`doctor/paper1/docs/验证结果_全量.md`](../验证结果_全量.md) — 定稿数字  
