...
Main quantitative results (RTT percentiles, valid-frame rate, retry rate) are produced \emph{offline} by \texttt{run\_matrix.py} (baselines B0--B3); the franka auxiliary track (M6) reports trend-consistent RTT only, not primary table numbers.
