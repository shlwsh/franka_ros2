...
\begin{enumerate}
  ...
  \item \textbf{LangGraph 路由：}物理重采下 B2 使 M2$=0.604$，相对 B0（M2$=0.560$）提升；M1 p50 由 374\,ms 降至 208\,ms。
  \item \textbf{真实 B3 对比：}MobileNet 验证准确率 98.3\%；$\tau_{B2}$ 下 B3 M2$=0.934$，$\tau_{B3}{=}0.5$ 下 B3t M2$=0.929$，混合 B4 M2$=0.936$，体现学习型排序与可解释路由的延迟--有效帧权衡。
