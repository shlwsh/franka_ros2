...
On an offline main experiment (500 frames $\times$ 3 seeds, baselines B0--B3), the proposed B2 configuration reduces median end-to-end RTT (M1 p50) from 397.6\,ms to 364.7\,ms versus naive upload (B0) while raising valid-frame rate (M2) from 0.50 to 0.99.
Edge-IQA runs at p95 $\approx$9.6\,ms per frame on CPU.
