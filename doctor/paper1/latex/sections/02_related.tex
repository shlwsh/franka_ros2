...
Neurosurgeon-style frameworks partition DNN layers across device, edge, and cloud; Paper~I differs by gating \emph{upload decisions} before any heavy cloud model executes, using a lightweight scorer (MobileNetV2~\cite{sandler2018mobilenetv2} backbone, p95 $\approx$9.6\,ms CPU) rather than partial DNN migration.
