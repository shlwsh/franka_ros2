...
The entity-map coverage report shows 10/10 KG entities mapped to project-local codes and FHIR targets; all ICD/SNOMED fields remain placeholder-only.
