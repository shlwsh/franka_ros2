...
> **更新日期**：2026-06-04（同步 Minor Revision 改稿：Pareto、分层 M2、NR-IQA 附录）
...
改进方案提到三选一：**Upload**【上传】/ **Resample**【重采】/ **EdgeProcess**【边侧处理：轻量增强后仍不上云】。  
...
1. ~~**网络扰动 sweep**【参数扫描】~~：✅ **quick**【快速验证】见 [论文I_网络扰动验证_20260530.md](../论文I_网络扰动验证_20260530.md)  
2. **upload**【上传】失败模型：差网络下 B2 vs B2d 公平对比  
3. **λ / α / u\* 敏感性曲线**：Fig. 消融补充  
4. **跨数据集 TCM-FD**【中医舌象跨域数据集】：τ 与 M2 泛化  
5. **EdgeProcess**【边侧处理】第三分支：效用函数完整三选一  
6. ~~**全量 3 seeds**【三随机种子】~~：✅ 2026-05-31 完成，见 [论文I_全量验证结果_20260531.md](../论文I_全量验证结果_20260531.md)  
7. ~~**多智能体审核 P0–P2**~~：✅ 2026-06-03 Minor Revision 7.2/10，见 `doctor/paper1/reviews/20260603-213904/`
